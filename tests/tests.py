...
from spreadlinks.linklibrarylib import LibrarySet, tagify
...
class SimpleTest(unittest.TestCase):
    ...
    def test_library_list_one(self):
        ...
        with open(os.path.join(self.dir_name, "foo/METADATA.txt"), "w") as output:
            output.write(
                "Title: Fabulous Object Organization\nBoo: Ba\n\nHello, world.\n\nPleased to be here!—"
            )
        ...
        self.assertHTMLEqual(
            "<p>Hello, world.</p><p>Pleased to be here!—</p>", lib.description_formatted
        )
    ...
    def test_simple_links(self):
        ...
        self.check_link(
            lib.all_links[0], "Crumbs", "http://example.org/", "Crummy", ["cake"]
        )
        self.check_link(
            lib.all_links[1], "Slime", "http://example.com/", "Slimy", ["goo"]
        )
    ...
    def test_tagging(self):
        ...
        self.assertEqual(
            set(["cake", "goo"]), lib.urldecode_keywords("cake+goo")["main"]
        )
    ...
    def test_other_keywords(self):
        ...
        self.assertEqual(
            "cat+colour:black+colour:white",
            lib.urlencode_keywords({"colour": ["black", "white"], "main": ["cat"]}),
        )
        self.assertEqual(
    ...
    def test_formatted_properties(self):
        ...
        self.assertHTMLEqual(
            "<p>Slimy</p><p>‘Wormy’</p>", lib.all_links[1].description_formatted
        )
        self.assertTrue(
            isinstance(lib.all_links[0].description_formatted, safestring.SafeText)
        )
